package com.example.application.views.elementos;
...
@Uses(Icon.class)
public class ElementosView extends Div {
    ...
    public ElementosView(SamplePersonService SamplePersonService) {
        this.samplePersonService = SamplePersonService;
        setSizeFull();
        addClassNames("elementos-view");
